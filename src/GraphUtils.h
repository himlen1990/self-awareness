...
IplImage* drawFloatGraph(const float *arraySrc, int nArrayLength, IplImage *imageDst DEFAULT(0), float minV DEFAULT(0.0), float maxV DEFAULT(0.0), int width DEFAULT(0), int height DEFAULT(0), const char *lineLabel=0, char *graphLabel DEFAULT(0), bool showScale DEFAULT(true));
